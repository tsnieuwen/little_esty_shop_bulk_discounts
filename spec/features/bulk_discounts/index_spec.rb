...
describe "merchant bulk discounts index" do
  ...
  it "can see all merchant's bulk discounts ids, percentages, and minimum number of items" do
    ...
    expect(page).to have_content(@bulk_discount1.percentage*100)
    expect(page).to have_content(@bulk_discount1.minimum)
  ...
  it "has a link to create new bulk discount page" do
    visit merchant_bulk_discounts_path(@merchant1)
  ...
  it "each bulk discount has a link to delete it" do
    visit merchant_bulk_discounts_path(@merchant1)

    expect(page).to have_link("Delete Bulk Discount ##{@bulk_discount1.id}")
    expect(page).to have_link("Delete Bulk Discount ##{@bulk_discount2.id}")
    expect(page).to_not have_link("Delete Bulk Discount ##{@bulk_discount3.id}")
